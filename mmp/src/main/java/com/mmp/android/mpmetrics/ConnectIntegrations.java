...
/* package */ class ConnectIntegrations {
    ...
    private void setAirshipPeopleProp() {
        ...
        try {
            ...
            MPLog.w(LOGTAG, "Airship SDK not found but Urban Airship is integrated on Mmp", e);
    ...
    private void setBrazePeopleProp() {
        ...
        try {
            ...
            if (currentUser == null) {
                MPLog.w(LOGTAG, "Make sure Braze is initialized properly before Mmp.");
                return;
            }
            ...
            MPLog.w(LOGTAG, "Braze SDK not found but Braze is integrated on Mmp", e);
        } catch (NoSuchMethodException e) {
