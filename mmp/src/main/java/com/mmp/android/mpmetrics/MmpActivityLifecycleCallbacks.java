...
/* package */ class MmpActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public MmpActivityLifecycleCallbacks(MmpAPI mpInstance, MPConfig config) {
    ...
    public void onActivityStarted(Activity activity) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= MPConfig.UI_FEATURES_MIN_API && mConfig.getAutoShowMmpUpdates()) {
