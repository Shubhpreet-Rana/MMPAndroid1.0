            ...
            if (message != null && message.length() > 0) {
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        MPLog.e(LOGTAG, "Removing people profile property from update (see https://github.com/mmp/mmp-android/issues/567)", e);
            ...
            public void handleMessage(Message msg) {
                ...
                try {
                    ...
                    if (msg.what == ENQUEUE_PEOPLE) {
                        ...
                        MPLog.e(LOGTAG, "Unexpected message received by Mmp worker: " + msg);
                    }
                    ...
                    synchronized (mHandlerLock) {
                        ...
                        try {
                            Looper.myLooper().quit();
                            MPLog.e(LOGTAG, "Mmp will not process any more analytics messages", e);
