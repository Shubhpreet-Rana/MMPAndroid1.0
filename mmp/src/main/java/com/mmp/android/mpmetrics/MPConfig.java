...
import static com.mmp.android.mpmetrics.MmpAPI.VERSION;
...
//import com.mmp.android.BuildConfig;
import com.mmp.android.util.MPConstants;
   ...
   public static final String VERSION = "1.0.0";
    ...
    /* package */ MPConfig(Bundle metaData, Context context) {
        ...
        try {
            ...
            MPLog.i("MmpAPI.Conf", "System has no SSL support. Built-in events editor will not be available", e);
        ...
        if (metaData.containsKey("com.mmp.android.MPConfig.DebugFlushInterval")) {
            MPLog.w(LOGTAG, "We do not support com.mmp.android.MPConfig.DebugFlushInterval anymore. There will only be one flush interval. Please, update your AndroidManifest.xml.");
        }
        ...
        if (dataExpirationMetaData != null) {
            try {
                ...
                MPLog.e(LOGTAG,"Error parsing com.mmp.android.MPConfig.DataExpiration meta-data value", e);
            }
        }
        ...
        if (eventsEndpoint != null) {
            ...
            setEventsEndpointWithBaseURL(MPConstants.URL.MMP_API);
        }
        ...
        if (peopleEndpoint != null) {
            ...
            setPeopleEndpointWithBaseURL(MPConstants.URL.MMP_API);
        }
        ...
        if (groupsEndpoint != null) {
            ...
            setGroupsEndpointWithBaseURL(MPConstants.URL.MMP_API);
        }
        ...
        if (decideEndpoint != null) {
            ...
            setDecideEndpointWithBaseURL(MPConstants.URL.MMP_API);
        }
    ...
    private static final String LOGTAG = "MmpAPI.Conf";
}
