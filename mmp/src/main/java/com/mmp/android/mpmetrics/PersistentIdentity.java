...
/* package */ class PersistentIdentity {
    ...
    public void updateSuperProperties(SuperPropertyUpdate updates) {
        synchronized (mSuperPropsLock) {
            ...
            if (replacementCache == null) {
                MPLog.w(LOGTAG, "An update to Mmp's super properties returned null, and will have no effect.");
                return;
            }
    ...
    public synchronized boolean isFirstIntegration(String token) {
        ...
        try {
            ...
            MPLog.e(LOGTAG, "Couldn't read internal Mmp shared preferences.", e.getCause());
        } catch (final InterruptedException e) {
            MPLog.e(LOGTAG, "Couldn't read internal Mmp from shared preferences.", e);
        }
        return firstLaunch;
    }
    ...
    public synchronized void setIsIntegrated(String token) {
        try {
            ...
            MPLog.e(LOGTAG, "Couldn't write internal Mmp shared preferences.", e.getCause());
        } catch (InterruptedException e) {
            MPLog.e(LOGTAG, "Couldn't write internal Mmp from shared preferences.", e);
        }
    }
    ...
    public synchronized void setHasLaunched(String token) {
        try {
            ...
            MPLog.e(LOGTAG, "Couldn't write internal Mmp shared preferences.", e);
        }
    }
    ...
    public synchronized HashSet<Integer> getSeenCampaignIds() {
        ...
        try {
            ...
            MPLog.e(LOGTAG, "Couldn't read Mmp shared preferences.", e.getCause());
        } catch (InterruptedException e) {
            MPLog.e(LOGTAG, "Couldn't read Mmp shared preferences.", e);
        }
        return campaignIds;
    }
