...
import com.mmp.android.mpmetrics.MPConfig;
...
import com.mmp.android.util.MPPair;
    ...
    private class ViewCrawlerHandler extends Handler {
        ...
        private void sendSnapshot(JSONObject message) {
            ...
            if (null == mSnapshot) {
                ...
                MPLog.w(LOGTAG, "Mmp editor is misconfigured, sent a snapshot request without a valid configuration.");
                return;
            }
